...
namespace oop_final
{
    public class AccountStudent
    {
        ...
        public AccountStudent()
        {
            ...
            studentAccounts.Add(new Student {maHS = "HS1",maLop ="L10A1",hoVaTen = "Trần Ngọc Mỹ", gioiTinh = 0, tenDangNhapHS = "mytran", matKhauHS = "mytran" });
            studentAccounts.Add(new Student {maHS = "HS2",maLop = "L10A1",hoVaTen = "Nguyễn Thiên Ân", gioiTinh = 0, tenDangNhapHS = "annguyen", matKhauHS = "annguyen" });
            studentAccounts.Add(new Student { maHS = "HS3", maLop = "L10A1", hoVaTen = "Lê An", gioiTinh = 1, tenDangNhapHS = "anle", matKhauHS = "anle" });
            studentAccounts.Add(new Student { maHS = "HS4", maLop = "L10A2", hoVaTen = "Lê Hoàng Phương", gioiTinh = 0, tenDangNhapHS = "phuongle", matKhauHS = "phuongle" });
            studentAccounts.Add(new Student { maHS = "HS5", maLop = "L10A2", hoVaTen = "Nguyễn Thúc Thùy Tiên", gioiTinh = 0, tenDangNhapHS = "tiennguyen", matKhauHS = "tiennguyen" });
            studentAccounts.Add(new Student { maHS = "HS6", maLop = "L10A2", hoVaTen = "Nguyễn Quốc Thiên", gioiTinh = 1, tenDangNhapHS = "thiennguyen", matKhauHS = "thiennguyen" });
            ...
            studentAccounts.Add(new Student { maHS = "HS16", maLop = "12A2", hoVaTen = "Trần Minh Tuấn", gioiTinh = 1, tenDangNhapHS = "tuantran", matKhauHS = "tuantran" });
